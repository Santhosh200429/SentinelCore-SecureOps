        ...
        <main className="auth-body auth-login-page">
            ...
            <section className="login-shell" aria-label="SentinelCore SecureOps sign in">
                ...
                <div className="login-form-panel">
                    ...
                    <div className="login-demo"><div className="login-demo-icon"><i className="ph ph-flask" /></div><div><strong>Demo access</strong><span><b>admin</b> / <b>admin123</b> · You can also register a new account.</span></div></div>
