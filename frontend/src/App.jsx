...
import SecurityEventsPage from './pages/SecurityEvents/SecurityEventsPage.jsx';
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/security-events" element={<ProtectedRoute permission="ASSET_VIEW"><SecurityEventsPage /></ProtectedRoute>} />
      ...
      <Route
        path="/devices"
        element={<ProtectedRoute permission="ASSET_VIEW"><DevicesPage /></ProtectedRoute>}
      />
